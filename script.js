...
const videgamesSearch = videogames.filter((game) => {
  return game.genders.find((element) => {
    return element === "RPG";
  });
});

const mediaSocre = videgamesSearch.reduce((total, nota) => {
  return total + nota.score;
}, 0);

console.log(mediaSocre); // Devuelve 31,5
